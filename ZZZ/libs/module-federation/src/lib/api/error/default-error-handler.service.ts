...
/**
 * Error Managements extends Angular errors to work with the message bus as well as offer unified way to
 * consume errors.
 *
 ...
 * Notifier to send messages outside of Ariba application to the global SAP.
 */
